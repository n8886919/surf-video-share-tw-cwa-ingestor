...
The app downloads the official CWA F-A0020-001 ZIP and F-A0021-001 tide data,
normalizes only the bounded 0–72 hour forecast window on the Home Assistant
host, then pushes small HMAC-authenticated batches to the public Worker. It
